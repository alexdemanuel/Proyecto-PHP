  ...
  <div class="row">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24"  height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
              ...
              <span data-feather="home"></span> Usuarios <span class="sr-only">(current)</span>
            </a>
          </li>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="btn-toolbar mb-2 mb-md-0" style="padding:10px;">
          <div class="btn-group mr-2">
          <a href="add.html" class="btn btn-sm btn-outline-secondary">Añadir Usuarios</a>
          </div>
      </div>
	...
	while($res = mysqli_fetch_array($result)) {
		...
		echo "<td><a href=\"edit.php?id=$res[id]\">Edit</a> | <a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a> | echo "<td><a href=\"view_producto.php?codigo_producto=$row[codigo_producto]\">View</a> </td>\n";
    echo "</tr>\n";
	}
